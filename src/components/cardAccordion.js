...
export default function CardAccordion(props) {
    ...
    return (<>
        <div class={`${cssCard.cardSecundario} flex flex-col gap-[1rem] justify-start items-center w-[21.88rem] p-2.5 rounded-[0.87rem] backdrop-blur-[13.8427734375px]`}>
